...
class FilesController extends GetxController {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                  title: const Text("Uzantıya Göre"),
                  onTap: () {
  ...
  void openFile(FileSystemEntity entity) {
  ...
  Future<void> pasteFile(String sourcePath, String destinationPath) async {
    try {
      final sourceFile = File(sourcePath);
      final destinationFile = File(destinationPath);
      await sourceFile.copy(destinationFile.path);
      print('Dosya başarıyla yapıştırıldı.');
    } catch (e) {
      print('Dosya yapıştırma hatası: $e');
    }
  }

  /*void doskop(String kaynak, String hedef) async {
    File kaynakDosya = File(kaynak);
    await kaynakDosya.copy(hedef);
  }

  void dosyap(FileSystemEntity kaynak, FileSystemEntity hedef) async {
    File kaynakDosya = File(kaynak);
    await kaynakDosya.copy(hedef);
  }*/
...
/*Future<void> openAudio() async {
  ...
  if (pickedFile != null) {
    // Dosya seçildiyse işlemleri yapın
    // Örneğin, dosyanın yolunu alabilir veya müziği çalabilirsiniz.
